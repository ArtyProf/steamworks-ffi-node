/**
 * Complete Workshop Item Lifecycle Test (TypeScript)
...
async function waitWithCallbacks(steam: any, ms: number): Promise<void> {
...
function createTestContent(): { contentPath: string; previewPath: string; cleanup: () => void } {
...
`);
  ...
  // Create a simple preview image (minimal valid JPEG)
...
async function testCompleteWorkshopLifecycle(): Promise<void> {
  console.log('🛠️  Complete Workshop Item Lifecycle Test');
  console.log('==========================================\n');
  
  const steam = SteamworksSDK.getInstance();
  let createdItemId: PublishedFileId | null = null;
  let testContent: ReturnType<typeof createTestContent> | null = null;
