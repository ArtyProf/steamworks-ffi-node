/**
 * Steam Apps/DLC Manager Test
 * 
 * Tests DLC ownership, app metadata, beta branches, and launch parameters
 * Run with: npx ts-node tests/ts/test-apps.ts
 */
...
// Test DLC download progress (will return null if nothing downloading)
...
console.log('       installDLC, uninstallDLC, getDlcDownloadProgress, setDlcContext');
...
console.log('        setActiveBeta');
console.log('  Launch: getLaunchQueryParam, getLaunchCommandLine');
console.log('  Misc: markContentCorrupt');
