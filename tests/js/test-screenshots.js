/**
 * Steam Screenshots Manager Test (JavaScript)
 * 
...
const { SteamworksSDK, INVALID_SCREENSHOT_HANDLE, EVRScreenshotType } = require('../../dist/index.js');
...
function createTestImage() {
  const tempDir = mkdtempSync(join(tmpdir(), 'steam-screenshot-test-'));
  const imagePath = join(tempDir, 'test_screenshot.jpg');
  ...
  writeFileSync(imagePath, minimalJpeg);
...
function createTestRGBData(width, height) {
