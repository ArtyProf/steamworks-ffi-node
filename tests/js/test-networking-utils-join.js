/**
 * Networking Utils Join Test (JavaScript)
 * 
 * This test demonstrates ping estimation between two players.
 * Run test-networking-utils-host.js first to get a ping location string,
 ...
 *   node tests/js/test-networking-utils-join.js "ping_location_string"
 */
...
async function testNetworkingUtilsJoin() {
  console.log('='.repeat(60));
  console.log('NETWORKING UTILS JOIN TEST (JavaScript)');
  console.log('='.repeat(60));
  console.log('');
  ...
  if (!remotePingLocation) {
    ...
    console.log('1. Run test-networking-utils-host.js and copy the location string');
    console.log('2. Pass a location string as argument:');
    console.log('   node tests/js/test-networking-utils-join.js "location_string"');
    console.log('');
