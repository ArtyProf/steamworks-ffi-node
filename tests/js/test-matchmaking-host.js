 ...
 * Run this on one machine, then run test-matchmaking-join.js on another machine
...
const { SteamworksSDK, ELobbyType } = require('../../dist');

async function testMatchmakingHost() {
  ...
  console.log('Run test-matchmaking-join.js on another machine to join.');
  console.log('');
  console.log('Or join directly with:');
  console.log(`  node tests/js/test-matchmaking-join.js ${lobbyId}`);
  console.log('');
