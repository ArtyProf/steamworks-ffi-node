/**
 * Steam Input Action Origins
 * 
 * These values represent all possible input origins across all supported controllers.
 * Use these when working with getDigitalActionOrigins(), getAnalogActionOrigins(),
 * getGlyphPNGForActionOrigin(), getGlyphSVGForActionOrigin(), etc.
 * 
 * Updated for Steamworks SDK 1.63 - includes Lenovo Legion Go controller support.
 * 
 * @see https://partner.steamgames.com/doc/api/ISteamInput
 */

/**
 * Input action origin values for all supported controllers
 */
export enum EInputActionOrigin {
  ...
  /** Xbox Series X controllers only */
  XBoxOne_Share = 147,
  ...
  /** Primary Gyro in Pro Controller, or Right JoyCon */
  ...
  /** Right JoyCon Gyro generally should correspond to Pro's single gyro */
  ...
  /** Left JoyCon SR Button */
  Switch_LeftGrip_Lower = 244,
  /** Left JoyCon SL Button */
  Switch_LeftGrip_Upper = 245,
  /** Right JoyCon SL Button */
  Switch_RightGrip_Lower = 246,
  /** Right JoyCon SR Button */
  Switch_RightGrip_Upper = 247,
  /** With a Horizontal JoyCon this will be Y or what would be Dpad Right when vertical */
  ...
  /** Left pad is only present on the original Legion Go */
  ...
  /** If Steam has added support for new controllers, origins will go here */
  Count = 495,
  /** Origins are currently a maximum of 16 bits */
  MaximumPossibleValue = 32767,
}

/**
 * Helper to check if an origin belongs to a specific controller type
 */
export const InputActionOriginRanges = {
  SteamController: { start: EInputActionOrigin.SteamController_A, end: EInputActionOrigin.SteamController_Reserved10 },
  PS4: { start: EInputActionOrigin.PS4_X, end: EInputActionOrigin.PS4_Reserved10 },
  XBoxOne: { start: EInputActionOrigin.XBoxOne_A, end: EInputActionOrigin.XBoxOne_Reserved10 },
  XBox360: { start: EInputActionOrigin.XBox360_A, end: EInputActionOrigin.XBox360_Reserved10 },
  Switch: { start: EInputActionOrigin.Switch_A, end: EInputActionOrigin.Switch_Reserved20 },
  PS5: { start: EInputActionOrigin.PS5_X, end: EInputActionOrigin.PS5_Reserved20 },
  SteamDeck: { start: EInputActionOrigin.SteamDeck_A, end: EInputActionOrigin.SteamDeck_Reserved20 },
  Horipad: { start: EInputActionOrigin.Horipad_M1, end: EInputActionOrigin.Horipad_R4 },
  LenovoLegionGo: { start: EInputActionOrigin.LenovoLegionGo_A, end: EInputActionOrigin.LenovoLegionGo_Reserved20 },
  Generic: { start: EInputActionOrigin.Generic_L4, end: EInputActionOrigin.Generic_MISC8 },
} as const;

/**
 * Check if an action origin belongs to a specific controller type
 */
export function isOriginFromController(origin: EInputActionOrigin, controller: keyof typeof InputActionOriginRanges): boolean {
  const range = InputActionOriginRanges[controller];
  return origin >= range.start && origin <= range.end;
}
